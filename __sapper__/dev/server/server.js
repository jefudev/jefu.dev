...
const css = {
	code: ":root{--card-ratio:0.2}.card.svelte-twoqon{perspective:1500px;transition:all 0.5s ease-in-out;-webkit-transition:all 0.5s ease-in-out;height:300px}.card__inner.svelte-twoqon{width:100%;height:100%;position:relative;transition:transform 0.6s cubic-bezier(0.65, 0, 0.35, 1);transform-style:preserve-3d}.card.is-flipped > .card__inner{transform:rotateY(-180deg)}.card.is-flipped{z-index:30}.card__front.svelte-twoqon,.card__back.svelte-twoqon{position:absolute;height:100%;width:100%;backface-visibility:hidden;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;top:0;left:0}.card__back.svelte-twoqon{transform:rotateY(-180deg)}@media(min-width: 640px){.card.svelte-twoqon{width:500px;transform:scale(min(max(calc(1.1 * var(--card-ratio)), 1), 1.1));opacity:max(calc(var(--card-ratio) * 1.1), 0.7)}.card.svelte-twoqon:hover{opacity:1;transform:scale(1.11)}.card.svelte-twoqon:active{transform:scale(1);transition:all 0.2s ease-in-out;-webkit-transition:all 0.2s ease-in-out}.card--scale-1{transform:scale(1) !important;opacity:0.7 !important}}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}",
	map: "{\"version\":3,\"file\":\"Cards.svelte\",\"sources\":[\"Cards.svelte\"],\"sourcesContent\":[\"<script>\\n  import Inview from 'svelte-inview';\\n  let ref;\\n  let cardRatio;\\n  let m = { x: 0, y: 0 };\\n\\n  function flipCard() {\\n    this.classList.toggle('is-flipped');\\n  }\\n\\n  function shrinkSiblings() {\\n    var x = document.getElementsByClassName('card');\\n    var i;\\n    for (i = 0; i < x.length; i++) {\\n      x[i].classList.add('card--scale-1');\\n    }\\n    this.classList.remove('card--scale-1');\\n  }\\n  function resetScale() {\\n    var x = document.getElementsByClassName('card');\\n    var i;\\n    for (i = 0; i < x.length; i++) {\\n      x[i].classList.remove('card--scale-1');\\n    }\\n  }\\n</script>\\n\\n<style>\\n  :root {\\n    --card-ratio: 0.2;\\n  }\\n  .card {\\n    perspective: 1500px;\\n    transition: all 0.5s ease-in-out;\\n    -webkit-transition: all 0.5s ease-in-out;\\n    height: 300px;\\n  }\\n  .card__inner {\\n    width: 100%;\\n    height: 100%;\\n    position: relative;\\n    transition: transform 0.6s cubic-bezier(0.65, 0, 0.35, 1);\\n    transform-style: preserve-3d;\\n  }\\n  :global(.card.is-flipped > .card__inner) {\\n    transform: rotateY(-180deg);\\n  }\\n  :global(.card.is-flipped) {\\n    z-index: 30;\\n  }\\n  .card__front,\\n  .card__back {\\n    position: absolute;\\n    height: 100%;\\n    width: 100%;\\n    backface-visibility: hidden;\\n    -webkit-backface-visibility: hidden;\\n    backface-visibility: hidden;\\n    -webkit-transform-style: preserve-3d;\\n    transform-style: preserve-3d;\\n    top: 0;\\n    left: 0;\\n  }\\n  .card__back {\\n    transform: rotateY(-180deg);\\n  }\\n  /* Small (sm) */\\n  @media (min-width: 640px) {\\n    .card {\\n      width: 500px;\\n      transform: scale(min(max(calc(1.1 * var(--card-ratio)), 1), 1.1));\\n      opacity: max(calc(var(--card-ratio) * 1.1), 0.7);\\n    }\\n    .card:hover {\\n      opacity: 1;\\n      transform: scale(1.11);\\n    }\\n    .card:active {\\n      transform: scale(1);\\n      transition: all 0.2s ease-in-out;\\n      -webkit-transition: all 0.2s ease-in-out;\\n    }\\n    :global(.card--scale-1) {\\n      transform: scale(1) !important;\\n      opacity: 0.7 !important;\\n    }\\n  }\\n\\n  /* Medium (md) */\\n  @media (min-width: 768px) {\\n    /* ... */\\n  }\\n\\n  /* Large (lg) */\\n  @media (min-width: 1024px) {\\n    /* ... */\\n  }\\n\\n  /* Extra Large (xl) */\\n  @media (min-width: 1280px) {\\n    /* ... */\\n  }\\n</style>\\n\\n<Inview\\n  let:inView\\n  let:scrollDirection\\n  let:entry\\n  wrapper={ref}\\n  rootMargin=\\\"-20% 0px\\\"\\n  on:change={event => (cardRatio = event.detail.entry.intersectionRatio)}\\n  threshold={Array.apply(null, { length: 100 }).map((n, i) => i / 100)}>\\n  <div\\n    class=\\\"w-full my-5 cursor-pointer card\\\"\\n    on:click={flipCard}\\n    bind:this={ref}\\n    style=\\\"--card-ratio: {cardRatio}\\\"\\n    on:mouseover={shrinkSiblings}\\n    on:mouseout={resetScale}>\\n    <div class=\\\"opacity-100 card__inner\\\">\\n      <div\\n        class=\\\"flex flex-col items-center p-4 my-4 bg-gray-200 border border-gray-300 rounded-lg shadow-lg card__front hover:shadow-2xl hover:bg-gray-300 active:shadow-lg\\\">\\n        <img\\n          src=\\\"https://unsplash.it/100/100?random&gravity=center\\\"\\n          class=\\\"w-16 h-16 mt-3 rounded-full\\\"\\n          alt=\\\"Company Logo\\\" />\\n        <p class=\\\"p-3 text-xl text-center\\\">\\n          I've built and led front-end development of 6 eCommerice sites from\\n          the ground up\\n        </p>\\n      </div>\\n      <div\\n        class=\\\"flex flex-col items-center p-4 my-4 bg-white border border-black rounded-lg shadow-lg card__back hover:shadow-2xl active:bg-gray-100 active:shadow-lg\\\">\\n        <p class=\\\"p-2 text-base\\\">\\n          Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis\\n          nemo sequi obcaecati totam repellendus? At explicabo consequatur\\n          voluptatem recusandae, distinctio nobis exercitationem totam quae\\n          soluta laboriosam perferendis provident optio voluptatibus.\\n          <span class=\\\"font-bold text-blue-700\\\">Circle Graphics</span>\\n        </p>\\n      </div>\\n    </div>\\n  </div>\\n</Inview>\\n\"],\"names\":[],\"mappings\":\"AA4BE,KAAK,AAAC,CAAC,AACL,YAAY,CAAE,GAAG,AACnB,CAAC,AACD,KAAK,cAAC,CAAC,AACL,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CAChC,kBAAkB,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CACxC,MAAM,CAAE,KAAK,AACf,CAAC,AACD,YAAY,cAAC,CAAC,AACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,SAAS,CAAC,IAAI,CAAC,aAAa,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CACzD,eAAe,CAAE,WAAW,AAC9B,CAAC,AACO,+BAA+B,AAAE,CAAC,AACxC,SAAS,CAAE,QAAQ,OAAO,CAAC,AAC7B,CAAC,AACO,gBAAgB,AAAE,CAAC,AACzB,OAAO,CAAE,EAAE,AACb,CAAC,AACD,0BAAY,CACZ,WAAW,cAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,mBAAmB,CAAE,MAAM,CAC3B,2BAA2B,CAAE,MAAM,CACnC,mBAAmB,CAAE,MAAM,CAC3B,uBAAuB,CAAE,WAAW,CACpC,eAAe,CAAE,WAAW,CAC5B,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,AACT,CAAC,AACD,WAAW,cAAC,CAAC,AACX,SAAS,CAAE,QAAQ,OAAO,CAAC,AAC7B,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,KAAK,cAAC,CAAC,AACL,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,MAAM,IAAI,IAAI,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACjE,OAAO,CAAE,IAAI,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,GAAG,CAAC,AAClD,CAAC,AACD,mBAAK,MAAM,AAAC,CAAC,AACX,OAAO,CAAE,CAAC,CACV,SAAS,CAAE,MAAM,IAAI,CAAC,AACxB,CAAC,AACD,mBAAK,OAAO,AAAC,CAAC,AACZ,SAAS,CAAE,MAAM,CAAC,CAAC,CACnB,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CAChC,kBAAkB,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,AAC1C,CAAC,AACO,cAAc,AAAE,CAAC,AACvB,SAAS,CAAE,MAAM,CAAC,CAAC,CAAC,UAAU,CAC9B,OAAO,CAAE,GAAG,CAAC,UAAU,AACzB,CAAC,AACH,CAAC,AAGD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAE3B,CAAC,AAGD,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAE5B,CAAC,AAGD,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAE5B,CAAC\"}"
};
...
const Cards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Inview, "Inview").$$render(
		...
		{},
		{
			default: ({ inView, scrollDirection, entry }) => `<div class="${"w-full my-5 cursor-pointer card svelte-twoqon"}" style="${"--card-ratio: " + escape(cardRatio)}"${add_attribute("this", ref, 1)}><div class="${"opacity-100 card__inner svelte-twoqon"}"><div class="${"flex flex-col items-center p-4 my-4 bg-gray-200 border border-gray-300 rounded-lg shadow-lg card__front hover:shadow-2xl hover:bg-gray-300 active:shadow-lg svelte-twoqon"}"><img src="${"https://unsplash.it/100/100?random&gravity=center"}" class="${"w-16 h-16 mt-3 rounded-full svelte-twoqon"}" alt="${"Company Logo"}">
        <p class="${"p-3 text-xl text-center svelte-twoqon"}">I&#39;ve built and led front-end development of 6 eCommerice sites from
          the ground up
        </p></div>
      <div class="${"flex flex-col items-center p-4 my-4 bg-white border border-black rounded-lg shadow-lg card__back hover:shadow-2xl active:bg-gray-100 active:shadow-lg svelte-twoqon"}"><p class="${"p-2 text-base svelte-twoqon"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis
          nemo sequi obcaecati totam repellendus? At explicabo consequatur
          voluptatem recusandae, distinctio nobis exercitationem totam quae
          soluta laboriosam perferendis provident optio voluptatibus.
          <span class="${"font-bold text-blue-700 svelte-twoqon"}">Circle Graphics</span></p></div></div></div>`
		}
	)}`;
});
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	$coords = get_store_value(coords);
	let y;
	let size = spring(10);
	validate_store(size, "size");
	$size = get_store_value(size);
...
<html lang="${"en"}"><body class="${"antialiased transition-all duration-500"}"><div id="${"circle_container"}" class="${"svelte-1tlv8vc"}"><svg class="${"z-50 svelte-1tlv8vc"}"><circle${add_attribute("cx", $coords.x, 0)}${add_attribute("cy", $coords.y + y, 0)}${add_attribute("r", $size, 0)} class="${"svelte-1tlv8vc"}"></circle></svg></div>
    ...
    <div class="${"py-16 bg-white"}">
      <div class="${"container w-screen px-4 mx-auto sm:px-8 lg:px-16 xl:px-20"}"><h1 class="${"w-full mb-8 text-6xl font-bold leading-tight text-center text-gray-900 md:text-5xl"}">Work
        ...
        <div class="${"flex flex-col items-center cards__container"}">${validate_component(Cards, "Cards").$$render($$result, { company: "Circle Graphics" }, {}, {})}
    ...
    <div class="${"sticky h-screen py-16 bg-gray-100 hero"}"></div>
    </body></html>`;
});
...
if (typeof window !== 'undefined') {
	new Promise(function (resolve) { resolve(require('./sapper-dev-client-857f8257.js')); }).then(client => {
