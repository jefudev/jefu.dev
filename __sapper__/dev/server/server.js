...
const css = {
	code: "@media(min-width: 640px){.card.svelte-1whyz43{perspective:1500px;width:500px;opacity:0;transition:all 0.2s ease-in-out;-webkit-transition:all 0.2s ease-in-out;transform:translateY(200px)}.card.svelte-1whyz43:hover{opacity:1;transform:scale(1.08)}.card.svelte-1whyz43:active{transform:scale(1);transition:all 0.2s ease-in-out;-webkit-transition:all 0.2s ease-in-out}.card__inner.svelte-1whyz43{width:100%;height:100%;position:relative;transition:transform 0.6s cubic-bezier(0.65, 0, 0.35, 1);transform-style:preserve-3d}.card.is-flipped > .card__inner{transform:rotateY(-180deg)}.card.is-flipped{z-index:30}.card__front.svelte-1whyz43,.card__back.svelte-1whyz43{position:relative;height:100%;width:100%;backface-visibility:hidden;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;top:0;left:0}.card__back.svelte-1whyz43{position:absolute;transform:rotateY(-180deg)}.animate.svelte-1whyz43{opacity:1;transition-duration:0.8s;transition-timing-function:cubic-bezier(0.25, 0.46, 0.45, 0.94);-moz-transition-timing-function:cubic-bezier(0.25, 0.46, 0.45, 0.94);transform:translateY(0);-moz-transform:translateY(0)}}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}",
	map: "{\"version\":3,\"file\":\"Card.svelte\",\"sources\":[\"Card.svelte\"],\"sourcesContent\":[\"<script>\\n  import Inview from 'svelte-inview';\\n  import { fly, slide } from 'svelte/transition';\\n  let ref;\\n  let m = { x: 0, y: 0 };\\n  let backVisible = false;\\n  export let data;\\n  function flipCard() {\\n    if (backVisible == false) {\\n      this.classList.toggle('is-flipped');\\n      backVisible = !backVisible;\\n    }\\n  }\\n  function openPage() {}\\n</script>\\n\\n<style>\\n  /* Small (sm) */\\n  @media (min-width: 640px) {\\n    .card {\\n      perspective: 1500px;\\n      width: 500px;\\n      opacity: 0;\\n      transition: all 0.2s ease-in-out;\\n      -webkit-transition: all 0.2s ease-in-out;\\n      transform: translateY(200px);\\n    }\\n    .card:hover {\\n      opacity: 1;\\n      transform: scale(1.08);\\n    }\\n    .card:active {\\n      transform: scale(1);\\n      transition: all 0.2s ease-in-out;\\n      -webkit-transition: all 0.2s ease-in-out;\\n    }\\n    .card__inner {\\n      width: 100%;\\n      height: 100%;\\n      position: relative;\\n      transition: transform 0.6s cubic-bezier(0.65, 0, 0.35, 1);\\n      transform-style: preserve-3d;\\n    }\\n    :global(.card.is-flipped > .card__inner) {\\n      transform: rotateY(-180deg);\\n    }\\n    :global(.card.is-flipped) {\\n      z-index: 30;\\n    }\\n    .card__front,\\n    .card__back {\\n      position: relative;\\n      height: 100%;\\n      width: 100%;\\n      backface-visibility: hidden;\\n      -webkit-backface-visibility: hidden;\\n      backface-visibility: hidden;\\n      -webkit-transform-style: preserve-3d;\\n      transform-style: preserve-3d;\\n      top: 0;\\n      left: 0;\\n    }\\n    .card__back {\\n      position: absolute;\\n      transform: rotateY(-180deg);\\n    }\\n    .animate {\\n      opacity: 1;\\n      transition-duration: 0.8s;\\n      transition-timing-function: cubic-bezier(0.25, 0.46, 0.45, 0.94);\\n      -moz-transition-timing-function: cubic-bezier(0.25, 0.46, 0.45, 0.94);\\n      transform: translateY(0);\\n      -moz-transform: translateY(0);\\n    }\\n  }\\n\\n  /* Medium (md) */\\n  @media (min-width: 768px) {\\n    /* ... */\\n  }\\n\\n  /* Large (lg) */\\n  @media (min-width: 1024px) {\\n    /* ... */\\n  }\\n\\n  /* Extra Large (xl) */\\n  @media (min-width: 1280px) {\\n    /* ... */\\n  }\\n</style>\\n\\n<Inview\\n  let:inView\\n  let:scrollDirection\\n  let:entry\\n  wrapper={ref}\\n  rootMargin=\\\"-25% 0px\\\"\\n  unobserveOnEnter=\\\"true\\\">\\n  <div bind:this={ref}>\\n    <div\\n      class=\\\"w-full my-5 cursor-pointer card\\\"\\n      on:click={flipCard}\\n      class:animate={inView}>\\n      <div\\n        class=\\\"bg-gray-200 border border-gray-300 rounded-lg opacity-100 card__inner card__front hover:bg-gray-300 active:bg-gray-400 active:opacity-75\\\">\\n        <div class=\\\"flex items-center px-4 pt-4\\\">\\n          <img\\n            src={data.img}\\n            class=\\\"flex-initial w-16 h-16 rounded-full\\\"\\n            alt=\\\"Company Logo\\\" />\\n          <p\\n            class=\\\"flex-auto pl-4 text-sm font-bold leading-4 text-left uppercase\\\">\\n            {data.frontHeader}\\n            <br />\\n            Front-end Dev, Design, design, design, design, design\\n          </p>\\n        </div>\\n        <div class=\\\"flex px-4 pt-2 pb-6\\\">\\n          <div class=\\\"w-full\\\">{data.frontBody}</div>\\n        </div>\\n        <a\\n          href=\\\"/\\\"\\n          class=\\\"absolute bottom-0 right-0 p-1 px-3 text-xs font-bold uppercase\\\">\\n          View More\\n        </a>\\n        <div\\n          class=\\\"flex flex-col items-center justify-center p-4 my-4 bg-white border border-black rounded-lg card__back active:bg-gray-100 active:opacity-75\\\">\\n          {#if backVisible}\\n            <p\\n              class=\\\"p-2 text-base\\\"\\n              transition:slide={{ delay: 400 }}\\n              on:outroend={openPage}>\\n              Lorem ipsum dolor sit amet consectetur adipisicing elit.\\n              Blanditiis nemo sequi obcaecati totam repellendus? At explicabo\\n              consequatur voluptatem recusandae, distinctio nobis exercitationem\\n              totam quae soluta laboriosam perferendis provident optio\\n              voluptatibus.\\n              <span class=\\\"font-bold text-blue-700\\\">Circle Graphics</span>\\n            </p>\\n          {/if}\\n        </div>\\n      </div>\\n    </div>\\n  </div>\\n</Inview>\\n\"],\"names\":[],\"mappings\":\"AAkBE,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,KAAK,eAAC,CAAC,AACL,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CAChC,kBAAkB,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CACxC,SAAS,CAAE,WAAW,KAAK,CAAC,AAC9B,CAAC,AACD,oBAAK,MAAM,AAAC,CAAC,AACX,OAAO,CAAE,CAAC,CACV,SAAS,CAAE,MAAM,IAAI,CAAC,AACxB,CAAC,AACD,oBAAK,OAAO,AAAC,CAAC,AACZ,SAAS,CAAE,MAAM,CAAC,CAAC,CACnB,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CAChC,kBAAkB,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,AAC1C,CAAC,AACD,YAAY,eAAC,CAAC,AACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,SAAS,CAAC,IAAI,CAAC,aAAa,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CACzD,eAAe,CAAE,WAAW,AAC9B,CAAC,AACO,+BAA+B,AAAE,CAAC,AACxC,SAAS,CAAE,QAAQ,OAAO,CAAC,AAC7B,CAAC,AACO,gBAAgB,AAAE,CAAC,AACzB,OAAO,CAAE,EAAE,AACb,CAAC,AACD,2BAAY,CACZ,WAAW,eAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,mBAAmB,CAAE,MAAM,CAC3B,2BAA2B,CAAE,MAAM,CACnC,mBAAmB,CAAE,MAAM,CAC3B,uBAAuB,CAAE,WAAW,CACpC,eAAe,CAAE,WAAW,CAC5B,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,AACT,CAAC,AACD,WAAW,eAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,QAAQ,OAAO,CAAC,AAC7B,CAAC,AACD,QAAQ,eAAC,CAAC,AACR,OAAO,CAAE,CAAC,CACV,mBAAmB,CAAE,IAAI,CACzB,0BAA0B,CAAE,aAAa,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,IAAI,CAAC,CAChE,+BAA+B,CAAE,aAAa,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,IAAI,CAAC,CACrE,SAAS,CAAE,WAAW,CAAC,CAAC,CACxB,cAAc,CAAE,WAAW,CAAC,CAAC,AAC/B,CAAC,AACH,CAAC,AAGD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAE3B,CAAC,AAGD,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAE5B,CAAC,AAGD,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAE5B,CAAC\"}"
};
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Inview, "Inview").$$render(
		...
		{},
		{
			default: ({ inView, scrollDirection, entry }) => `<div${add_attribute("this", ref, 1)}><div class="${["w-full my-5 cursor-pointer card svelte-1whyz43", inView ? "animate" : ""].join(" ").trim()}"><div class="${"bg-gray-200 border border-gray-300 rounded-lg opacity-100 card__inner card__front hover:bg-gray-300 active:bg-gray-400 active:opacity-75 svelte-1whyz43"}"><div class="${"flex items-center px-4 pt-4"}"><img${add_attribute("src", data.img, 0)} class="${"flex-initial w-16 h-16 rounded-full"}" alt="${"Company Logo"}">
          <p class="${"flex-auto pl-4 text-sm font-bold leading-4 text-left uppercase"}">${escape(data.frontHeader)}
            <br>
            Front-end Dev, Design, design, design, design, design
          </p></div>
        <div class="${"flex px-4 pt-2 pb-6"}"><div class="${"w-full"}">${escape(data.frontBody)}</div></div>
        <a href="${"/"}" class="${"absolute bottom-0 right-0 p-1 px-3 text-xs font-bold uppercase"}">View More
        </a>
        <div class="${"flex flex-col items-center justify-center p-4 my-4 bg-white border border-black rounded-lg card__back active:bg-gray-100 active:opacity-75 svelte-1whyz43"}">${ ``}</div></div></div></div>`
		}
	)}`;
});

/* src/components/WorkCards.svelte generated by Svelte v3.24.1 */

const css$1 = {
	code: ".parallax__container.svelte-1bssjgq{position:fixed;height:800px}.parallax__img.svelte-1bssjgq{position:absolute;max-width:300px;width:auto;justify-self:center;transition:transform 0.2s ease-out;margin-top:50px}",
	map: "{\"version\":3,\"file\":\"WorkCards.svelte\",\"sources\":[\"WorkCards.svelte\"],\"sourcesContent\":[\"<script>\\n  import Card from './Card.svelte';\\n  let works = [\\n    {\\n      work: 'Circle Graphics',\\n      img: 'https://unsplash.it/100/100?random&gravity=center',\\n      frontHeader: '2016 - Present',\\n      frontBody:\\n        'Magna id non exercitation ut aute. Tempor reprehenderit nostrud et velit do labore velit eu sit aliqua laborum. Ad duis elit excepteur anim nulla incididunt elit tempor aliquip irure anim. Esse velit pariatur minim incididunt ad officia irure laboris laborum deserunt occaecat. Pariatur do Lorem dolore reprehenderit fugiat nostrud ex consequat. Dolor sit cillum eu quis mollit dolore consequat elit adipisicing amet exercitation ullamco qui mollit.'\\n    },\\n    {\\n      work: 'University of California, San Diego',\\n      img: 'https://unsplash.it/100/200?random&gravity=center',\\n      frontBody:\\n        'Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.'\\n    },\\n    {\\n      work: 'Infinite Domain',\\n      img: 'https://unsplash.it/200/100?random&gravity=center',\\n      frontBody:\\n        'Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.'\\n    },\\n    { work: 'Film', img: 'https://unsplash.it/100/300?random&gravity=center' },\\n    {\\n      work: 'Illustrations',\\n      img: 'https://unsplash.it/200/200?random&gravity=center'\\n    }\\n  ];\\n  let y;\\n</script>\\n\\n<style>\\n  .parallax__container {\\n    position: fixed;\\n    height: 800px;\\n  }\\n  .parallax__img {\\n    position: absolute;\\n    max-width: 300px;\\n    width: auto;\\n    justify-self: center;\\n    transition: transform 0.2s ease-out;\\n    margin-top: 50px;\\n  }\\n</style>\\n\\n<svelte:window bind:scrollY={y} />\\n<!-- container -->\\n\\n<div\\n  class=\\\"container w-screen min-h-screen px-4 mx-auto sm:px-8 lg:px-16 xl:px-20\\\">\\n  <h1\\n    class=\\\"w-full mb-8 text-5xl font-bold leading-tight text-center text-gray-900 font--brume\\\">\\n    Work\\n  </h1>\\n  <div class=\\\"relative z-10 flex flex-col items-center cards__container\\\">\\n    {#each works as work}\\n      <Card data={work} />\\n    {/each}\\n  </div>\\n  <div class=\\\"container top-0 z-0 parallax__container\\\">\\n    <img\\n      class=\\\"parallax__img\\\"\\n      style=\\\"transform: translate(0,{(-y * -1) / 5}px) rotate({y}deg);height:50px;\\n      right:350px\\\"\\n      src=\\\"shapes/scribble-5-min.png\\\"\\n      alt=\\\"shape layer scribble\\\" />\\n    <img\\n      class=\\\"parallax__img\\\"\\n      style=\\\"transform: translate(0,{(-y * -3) / 5}px) rotateY({y / 20}deg)\\n      rotate({y / 10}deg);transform-style:preserve-3d;\\\"\\n      src=\\\"shapes/grid-min.png\\\"\\n      alt=\\\"shape layer grid\\\" />\\n  </div>\\n\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAgCE,oBAAoB,eAAC,CAAC,AACpB,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,KAAK,AACf,CAAC,AACD,cAAc,eAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,IAAI,CACX,YAAY,CAAE,MAAM,CACpB,UAAU,CAAE,SAAS,CAAC,IAAI,CAAC,QAAQ,CACnC,UAAU,CAAE,IAAI,AAClB,CAAC\"}"
};

const WorkCards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let works = [
		{
			work: "Circle Graphics",
			img: "https://unsplash.it/100/100?random&gravity=center",
		...
		},
		{
			work: "University of California, San Diego",
			img: "https://unsplash.it/100/200?random&gravity=center",
			frontBody: "Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment."
		},
		{
			work: "Infinite Domain",
			img: "https://unsplash.it/200/100?random&gravity=center",
			frontBody: "Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring."
		},
		{
			work: "Film",
			img: "https://unsplash.it/100/300?random&gravity=center"
		},
		{
			work: "Illustrations",
			img: "https://unsplash.it/200/200?random&gravity=center"
...
<div class="${"container w-screen min-h-screen px-4 mx-auto sm:px-8 lg:px-16 xl:px-20"}"><h1 class="${"w-full mb-8 text-5xl font-bold leading-tight text-center text-gray-900 font--brume"}">Work
  </h1>
  <div class="${"relative z-10 flex flex-col items-center cards__container"}">${each(works, work => `${validate_component(Card, "Card").$$render($$result, { data: work }, {}, {})}`)}</div>
  <div class="${"container top-0 z-0 parallax__container svelte-1bssjgq"}"><img class="${"parallax__img svelte-1bssjgq"}" style="${"transform: translate(0," + escape(-y * -1 / 5) + "px) rotate(" + escape(y) + "deg);height:50px;\n      right:350px"}" src="${"shapes/scribble-5-min.png"}" alt="${"shape layer scribble"}">
    <img class="${"parallax__img svelte-1bssjgq"}" style="${"transform: translate(0," + escape(-y * -3 / 5) + "px) rotateY(" + escape(y / 20) + "deg)\n      rotate(" + escape(y / 10) + "deg);transform-style:preserve-3d;"}" src="${"shapes/grid-min.png"}" alt="${"shape layer grid"}"></div></div>`;
});
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"container px-4 mx-auto sm:px-8 xl:px-20"}">
    <div class="${"flex items-center justify-between"}">
      ...
      <navbar class="${"hidden navbar md:block"}"><ul class="${"flex space-x-8 text-lg"}"><li><button class="${"px-4 py-2 font-medium duration-500 hover:text-jefu-blue-500"}">Work
            </button></li>
          <li><button class="${"px-4 py-2 font-medium duration-500 hover:text-jefu-blue-500"}">About
            </button></li></ul></navbar></div></div></header>`;
});
...
<div class="${"sticky z-10 py-16 bg-gray-100 hero"}">
  <div class="${"container px-4 mx-auto transition-all duration-300 sm:px-8 xl:px-20"}">
    <div class="${"grid items-center grid-cols-1 gap-8 md:grid-cols-12"}">
      <div class="${"hidden col-span-5 md:block"}"><h1 class="${"max-w-xl text-6xl font-bold text-gray-900 font--brume\n          md:text-5xl"}">Hello, I&#39;m
      ...
      <div class="${"block col-span-12 md:hidden"}"><h1 class="${"max-w-xl pb-8 text-6xl font-bold text-center text-gray-900\n          font--brume"}">Hello, I&#39;m
...
const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"sticky p-16 bg-gray-100"}" id="${"about"}"><div class="${"container"}"><div class="${"grid items-center grid-cols-1 gap-8 md:grid-cols-12"}"><div class="${"col-span-12"}"><h1 id="${"about"}" class="${"w-full mb-8 text-5xl font-bold leading-tight text-center\n          text-gray-900 font--brume"}">About
        </h1></div>
      ${validate_component(Inview, "Inview").$$render(
		$$result,
		{
        ...
        <div class="${"col-span-6"}"><div class="${[
				"p-4 text-lg leading-relaxed text-gray-900 duration-500\n            delay-1000 opacity-0",
				inView ? "opacity-100" : ""
			].join(" ").trim()}">Voluptate irure aliquip consectetur occaecat consequat nulla eiusmod
            quis aute laborum dolore ipsum enim. Et voluptate excepteur
            incididunt non dolor veniam. Aliqua excepteur sit culpa est ipsum id
            do. Ad cupidatat commodo non quis velit cupidatat ea qui proident
            eiusmod mollit. Sit in aute Lorem cillum tempor ipsum pariatur magna
            eiusmod deserunt velit voluptate enim est.
          </div></div>`
		}
	)}</div></div></div>`;
});
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<header class="${"sticky z-50 py-16 bg-white border-t-2"}"><div class="${"container px-4 mx-auto sm:px-8 lg:px-16 xl:px-20"}"><div class="${"flex items-center justify-start"}"><div><h1 class="${"font-semibold leading-relaxed text-gray-900 "}">© Jeff Lau, ${escape(year)}</h1>
        <p class="${"text-base leading-relaxed"}">Designed by Jeff. Made with Svelte.
        </p>
        <p class="${"text-base leading-relaxed"}"><a href="${"https://www.linkedin.com/in/jefudev/"}" class="${"pr-2"}">LinkedIn
          ...
          <a href="${"mailto:hi@jefu.dev"}">Email</a></p></div></div></div></header>`;
});
...
<html lang="${"en"}"><body class="${"antialiased transition-all duration-500"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
    ...
    <div class="${"py-16 bg-white work__cards"}" id="${"work"}">${validate_component(WorkCards, "WorkCards").$$render($$result, {}, {}, {})}</div>
    ${validate_component(About, "About").$$render($$result, {}, {}, {})}</body>
...
if (typeof window !== 'undefined') {
	new Promise(function (resolve) { resolve(require('./sapper-dev-client-7afe8dab.js')); }).then(client => {
